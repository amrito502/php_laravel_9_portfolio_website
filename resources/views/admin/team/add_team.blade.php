...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span>Add Team Members</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="{{ route('store.team') }}" method="post"
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="facebook" name="facebook" placeholder="fontawsome facebook Icon Link">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="twitter">Enter Fontawsome Twitter Icon Link</label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="twitter" name="twitter" placeholder="fontawsome twitter Icon Link">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="instagram">Enter Fontawsome Instagram Icon Link</label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="instagram" name="instagram" placeholder="fontawsome instagram Icon Link">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="linkedin">Enter Fontawsome Linkedin Icon Link</label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="linkedin" name="linkedin" placeholder="fontawsome linkedin Icon Link">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="add-btn">Add Team Members</button>
                    </div>
                </fieldset>
            </form>
