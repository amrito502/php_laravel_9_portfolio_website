...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span>Update Profile Data</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="{{ route('update.profile',$profile->id) }}" method="post"
                ...
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="name" name="name"
                                placeholder="Enter Name" value="{{ $profile->name }}">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="prof" name="prof"
                                placeholder="Enter Profession" value="{{ $profile->prof }}">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="facebook" name="facebook"
                                placeholder="Enter Facebook Profile Link" value="{{ $profile->facebook }}">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="twitter" name="twitter"
                                placeholder="Enter Twitter Profile Link" value="{{ $profile->twitter }}">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="instagram" name="instagram"
                                placeholder="Enter Instagram Profile Link" value="{{ $profile->instagram }}">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="linkedin" name="linkedin"
                                placeholder="Enter linkedin Profile Link" value="{{ $profile->linkedin }}">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="image">Choose Profile Image</label>
                        <div class="controls">
                        <img src="{{ asset('images/profile/'.$profile->image) }}" width="50px">
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="" id="about_desc" rows="3" name="about_desc">{{ $profile->about_desc }}</textarea>
                        </div>
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="add-btn">Update Profile</button>
                        <a href="{{ route('profile') }}" class="btn btn-danger">Back Profile</a>
                    </div>
                </fieldset>
            </form>
