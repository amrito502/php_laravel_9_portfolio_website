...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="{{ route('store.portfolio') }}" method="post"
                enctype="multipart/form-data">
                @csrf
                <fieldset>
                <div class="control-group">
                        <label class="control-label" for="item_1">Portfolio Name</label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="item_1" name="item_1"
                                placeholder="write Portfolio Name">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="item_2">Portfolio Item-1</label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="item_2" name="item_2"
                                placeholder="write item-1">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="item_3">Portfolio Item-2</label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="item_3" name="item_3"
                                placeholder="write item-2">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="item_4">Portfolio Item-3</label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="item_4" name="item_4"
                                placeholder="write item-3">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="item_5">Portfolio Item-4</label>
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="item_5" name="item_5"
                                placeholder="write item-4">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="" id="description" rows="3" name="desc" placeholder="write Description"></textarea>
                        </div>
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="add-btn">Add Portfolio</button>
                    </div>
                </fieldset>
            </form>
