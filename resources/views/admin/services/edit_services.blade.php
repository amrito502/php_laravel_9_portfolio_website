...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="{{ route('update.services',$service->id) }}" method="post"
                ...
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="{{ $service->target }}"   class="span6 typeahead" id="target" name="target"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="{{ $service->name }}" class="span6 typeahead" id="name" name="name"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text"value="{{ $service->title }}" class="span6 typeahead" id="title" name="title"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text"value="{{ $service->item_1 }}" class="span6 typeahead" id="item" name="item_1"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text"value="{{ $service->item_2 }}" class="span6 typeahead" id="item" name="item_2"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text"value="{{ $service->item_3 }}" class="span6 typeahead" id="item" name="item_3"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text"value="{{ $service->item_4 }}" class="span6 typeahead" id="item" name="item_4"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text"value="{{ $service->item_5 }}" class="span6 typeahead" id="item" name="item_5"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        <img src="{{ asset('images/services/'.$service->image) }}" width="50px">
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="" id="description" rows="3" name="description">{{ $service->description }}</textarea>
                        </div>
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="edit-btn">Update Services</button>
                    </div>
                </fieldset>
            </form>
