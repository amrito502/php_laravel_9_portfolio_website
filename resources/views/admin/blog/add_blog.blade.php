...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span>Post Blog</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="{{ route('store.blog') }}" method="post"
                ...
                <fieldset>
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="" id="description" placeholder="Write Blog Description" rows="3" name="description"></textarea>
                        </div>
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" name="add-btn">Post Blog</button>
                    </div>
                </fieldset>
            </form>
